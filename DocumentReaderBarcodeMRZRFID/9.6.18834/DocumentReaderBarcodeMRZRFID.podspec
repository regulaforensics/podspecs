Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderBarcodeMRZRFID'
  s.version                 = '9.6.18834'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/BarcodeMRZRFID/9.6.18834/DocumentReaderCore_barcodemrzrfid_9.6.18834.zip' }
  s.platform                = :ios
