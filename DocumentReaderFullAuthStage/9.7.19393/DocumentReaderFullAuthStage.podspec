Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderFullAuthStage'
  s.version                 = '9.7.19393'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/FullAuthStage/9.7.19393/DocumentReaderCoreStage_fullauth_9.7.19393.zip' }
  s.platform                = :ios
