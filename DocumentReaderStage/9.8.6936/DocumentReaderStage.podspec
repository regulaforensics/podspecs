Pod::Spec.new do |s|
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/DocumentReaderStage/9.8.6936/DocumentReaderStage-9.8.6936.zip' }
  s.platform                = :ios
  s.weak_frameworks         = 'CoreNFC'
  s.ios.deployment_target   = '13.0.0'
  s.ios.vendored_frameworks = 'DocumentReader.xcframework'
  s.dependency                'RegulaCommonStage', '9.8.2763'
end
