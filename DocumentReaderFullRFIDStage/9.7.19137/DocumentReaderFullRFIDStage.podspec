Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderFullRFIDStage'
  s.version                 = '9.7.19137'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/FullRFIDStage/9.7.19137/DocumentReaderCoreStage_fullrfid_9.7.19137.zip' }
  s.platform                = :ios
