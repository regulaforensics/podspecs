Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderMRZBarcodeStage'
  s.version                 = '9.6.18520'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/MRZBarcodeStage/9.6.18520/DocumentReaderCoreStage_barcodemrz_9.6.18520.zip' }
  s.platform                = :ios
