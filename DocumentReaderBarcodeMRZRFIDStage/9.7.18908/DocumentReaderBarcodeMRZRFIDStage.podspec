Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderBarcodeMRZRFIDStage'
  s.version                 = '9.7.18908'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/BarcodeMRZRFIDStage/9.7.18908/DocumentReaderCoreStage_barcodemrzrfid_9.7.18908.zip' }
  s.platform                = :ios
