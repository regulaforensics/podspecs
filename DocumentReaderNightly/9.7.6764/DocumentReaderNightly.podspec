Pod::Spec.new do |s|
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Nightly/DocumentReaderNightly/9.7.6764/DocumentReaderNightly-9.7.6764.zip' }
  s.platform                = :ios
  s.weak_frameworks         = 'CoreNFC'
  s.ios.deployment_target   = '13.0.0'
  s.ios.vendored_frameworks = 'DocumentReader.xcframework'
  s.dependency                'RegulaCommonNightly', '9.7.2592'
end
