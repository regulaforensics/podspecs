Pod::Spec.new do |s|
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Nightly/IDVDocumentReaderNightly/3.10.3775/IDVDocumentReaderNightly-3.10.3775.zip' }
  s.platform                = :ios
  ...
  s.dependency                'DocumentReaderNightly', '>= 9.8.6911'
end
