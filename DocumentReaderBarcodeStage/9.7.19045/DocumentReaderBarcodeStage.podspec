Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderBarcodeStage'
  s.version                 = '9.7.19045'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/BarcodeStage/9.7.19045/DocumentReaderCoreStage_barcode_9.7.19045.zip' }
  s.platform                = :ios
