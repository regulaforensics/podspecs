Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderFullAuthRFIDBeta'
  s.version                 = '9.6.18761'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/FullAuthRFIDBeta/9.6.18761/DocumentReaderCoreBeta_fullauthrfid_9.6.18761.zip' }
  s.platform                = :ios
