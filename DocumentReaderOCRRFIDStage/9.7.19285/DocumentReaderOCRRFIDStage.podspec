Pod::Spec.new do |s|
  s.name                    = 'DocumentReaderOCRRFIDStage'
  s.version                 = '9.7.19285'
  ...
  s.source                  = { http: 'https://pods.regulaforensics.com/Stage/OCRRFIDStage/9.7.19285/DocumentReaderCoreStage_ocrandmrzrfid_9.7.19285.zip' }
  s.platform                = :ios
